...
/*
	...
	Controller 는 servlet-context.xml 로 리턴한다.
	하지만 RestController 는 servlet-context.xml 로 리턴하지 않고 브라우저에 출력된다.
	반환형이 String 인 경우 문서 타입을 contentType="text/html" 로 변경시킬 수 있다.
...
public class AjaxTestController {
	...
	@ResponseBody  //반환형이 String 인 경우 문서 타입을 contentType="text/html" 로 자동 변경시킬 수 있다.
	...
	public String Xml_Exam03() {
		...
		try {
		     ...
		     urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=LkszoaB9PoTqaCKm0vR4Q3zRoLR2QbX4MBfubWt%2FMY2GldMYHTO4z%2BXJuABaEHWKv6LGVYIF9iPe0OPwPEdCog%3D%3D"); /*자기 자신의 Service Key*/
	...
	public String Json_Exam03() {
		...
		try {
	        ...
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=LkszoaB9PoTqaCKm0vR4Q3zRoLR2QbX4MBfubWt%2FMY2GldMYHTO4z%2BXJuABaEHWKv6LGVYIF9iPe0OPwPEdCog%3D%3D"); /*Service Key*/
	        urlBuilder.append("&" + URLEncoder.encode("pageNo","UTF-8") + "=" + URLEncoder.encode("1", "UTF-8")); /*페이지번호*/
	        urlBuilder.append("&" + URLEncoder.encode("numOfRows","UTF-8") + "=" + URLEncoder.encode("10", "UTF-8")); /*한 페이지 결과 수*/
