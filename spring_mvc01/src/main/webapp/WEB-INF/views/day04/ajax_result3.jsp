...
<body>
			...
			<tfoot>
				<tr>
					<td colspan="4" align="center"><input type="button"
						value="가입하기" id="btn_join" disabled></td>
				</tr>
			</tfoot>
		</table>
	</form>
	...
	<script type="text/javascript">
		...
		function toggleJoinButton() {
			...
			const ageField = $("#m_age").val() !== ""
					&& parseInt($("#m_age").val()) > 0;
		...
		// 파라미터가 하나일때 => data : "m_id=" + $("#m_id").val()
		// 파라미터가 여러개일때 => 보통 직렬화(serialize()) => form태그 안에서만 가능
